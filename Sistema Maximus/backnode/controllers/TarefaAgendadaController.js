             ...
             array = await req.body.array
                ...
                '
                    select 
                        id, 
                        nome, 
                        repetir_tarefa_a_cada_valor, 
                        repetir_tarefa_a_cada_chave, 
                        data_ult_execucao, 
                        is_ativo, 
                        coalesce(error, '''') as error, 
                        tentativas 
                    from historico..TarefaAgendada
                ');
...
module.exports = new TarefaAgendadaController();